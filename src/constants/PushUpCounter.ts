...
// TODO: Change Approach To Arrange The Files And Folder.
export const instructionMessages: string[] = [
  'Place your phone on the flat ground',
  'Position yourself in pushup position above the phone',
  'Make sure your face is visible in the phone when in starting position',
  'Press the play button to start counting your pushups',
];
